...
$(function(){
    ...
    //포트폴리오 모달창
    const $portShadow = $('.port-shadow');
    const $portLightbox = $('.port-lightbox');
    const $portBtnClse = $('.clse');
    ...
    $('.gosite_3').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_4').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_5').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_6').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_7').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_8').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_9').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_10').on('click', function(evt){
        evt.preventDefault();
    ...
    $('.gosite_11').on('click', function(evt){
        evt.preventDefault();
